---
name: mastra
description: "Mastra AI agent framework."
version: 1.0.0
author: Community
license: MIT
...
```bash
npx mdskills install mastra-ai/mastra
```
...
| Agent | Path |
|-------|------|
| **opencode** | ~/.config/opencode/skills/mastra/SKILL.md |
| **Claude Code** | ~/.claude/skills/mastra/SKILL.md |
| **Hermes** | ~/.hermes/skills/marketplace/mastra/SKILL.md |
