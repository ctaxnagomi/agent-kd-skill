---
name: agno
description: "Agno AI agent framework."
version: 1.0.0
author: Community
license: MIT
...
```bash
npx mdskills install agno-agi/agno
```
...
| Agent | Path |
|-------|------|
| **opencode** | ~/.config/opencode/skills/agno/SKILL.md |
| **Claude Code** | ~/.claude/skills/agno/SKILL.md |
| **Hermes** | ~/.hermes/skills/marketplace/agno/SKILL.md |
